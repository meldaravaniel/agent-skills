...
Reads grading.json files from config directories and produces:
...
Expected directory layout:
    ...
    └── eval-N/
        ├── eval_metadata.json
        ├── with_skill/
        │   ├── outputs/        <- subagent-produced files
...
def load_run_results(benchmark_dir: Path) -> dict:
    ...
    """
    # Support eval dirs directly under benchmark_dir, or under runs/ (legacy)
    ...
    for eval_idx, eval_dir in enumerate(sorted(search_dir.glob("eval-*"))):
        ...
        for config_dir in sorted(eval_dir.iterdir()):
            ...
            # Compute summary from expectations if not explicitly provided
